...
#define NCCL_FUNC5(func, algo, redop, type) \
  WITH_COMMA(NCCL_FUNC_NAME(func, algo, LL,     redop, type)) \
  WITH_COMMA(NCCL_FUNC_NAME(func, algo, LL128,  redop, type)) \
  WITH_COMMA(NCCL_FUNC_NAME(func, algo, SIMPLE, redop, type))

#define NCCL_FUNC5_ELE(algo, func, redop, type) \
  NCCL_FUNC5(func, algo,    redop, type)
...
#define NCCL_FUNCS() { \
  WITH_COMMA(NCCL_FUNC_NAME(SendRecv, RING, SIMPLE, Sum, int8_t))\
