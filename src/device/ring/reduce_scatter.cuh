...
class ncclFunction<ncclCollReduceScatter, NCCL_ALGO_RING, NCCL_PROTO_SIMPLE, RedOp, T, UNROLL> {
  public:
...
template<class RedOp, typename T, int UNROLL>
class ncclFunction<ncclCollReduceScatter, NCCL_ALGO_RING, NCCL_PROTO_LL, RedOp, T, UNROLL> {
  public:
    __device__ void run(struct CollectiveArgs* args) {
...
template<class RedOp, typename T, int UNROLL>
class ncclFunction<ncclCollReduceScatter, NCCL_ALGO_RING, NCCL_PROTO_LL128, RedOp, T, UNROLL> {
  public:
    __device__ void run(struct CollectiveArgs* args) {
