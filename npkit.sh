...
NPKIT_NCCL_TEST_BIN_ALLREDUCE="/test/build/all_reduce_perf"
# NPKIT_NCCL_TEST_BIN_ALLTOALL="/test/build/alltoall_perf"
...
export NPKIT_FLAGS=${NPKIT_FLAGS}" -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTRA_REDUCESCATTER_ENTRY -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTRA_REDUCESCATTER_EXIT -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTER_ENTRY -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTER_EXIT -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTRA_ALLGATHER_ENTRY -DENABLE_NPKIT_EVENT_ALL_REDUCE_RING2D_INTRA_ALLGATHER_EXIT"
